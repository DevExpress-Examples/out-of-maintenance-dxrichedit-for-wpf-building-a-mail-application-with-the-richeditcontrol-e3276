...
namespace RichEditSendMail {
    ...
    public partial class MainWindow : Window {
        ...
        public class RichEditMailMessageExporter : IUriProvider {
            ...
            OfficeImageFormat GetActualImageFormat(OfficeImageFormat OfficeImageFormat) {
                if (OfficeImageFormat == OfficeImageFormat.Exif ||
                    OfficeImageFormat == OfficeImageFormat.MemoryBmp)
